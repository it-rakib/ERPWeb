...
namespace DBManager
{
    public class CommonConnectionLand
    {
        public string constring = ConfigurationManager.ConnectionStrings["LANDDBConnectionString"].ToString();
        ...
        public CommonConnectionLand(IsolationLevel readCommitted)
        {
            ...
            if (ConnectionType != null && ConnectionType == "SQL")
            {
                ...
                dbConnection = new SqlConnection(connections["LANDDBConnectionString"].ConnectionString);
                IsConfigureDb = true;
            }
            else
            {
