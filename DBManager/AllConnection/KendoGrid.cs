...
namespace DBManager.AllConnection
{
    public class KendoGrid<T>
    {
        ...
        public static GridEntity<T> GetGridData(string conStr, GridOptions gridOption, string ProcName, string CallType, string orderby, int param1 = 0, string param2 = "")
        {
            try
            {
        ...
        public static GridEntity<T> GetGenericGridData(string conStr, GridOptions gridOption, string ProcName, string CallType, string orderby, int param1 = 0, string param2 = "")
        {
            try
            {
                gridOption.take = gridOption.skip + gridOption.take;
        ...
        public static GridEntity<T> GetGridData_5(string conStr, GridOptions gridOption, string ProcName, string CallType, string orderby, string param1 = "", string param2 = "", string param3 = "", string param4 = "", string param5 = "")
        {
            try
            {
                gridOption.take = gridOption.skip + gridOption.take;
        ...
        public static GridEntity<T> GetGridData_No_Paging(string conStr, string comname, string ProcName, string CallType, string parm1 = "", string parm2 = "", string parm3 = "", string parm4 = "", string parm5 = "", string parm6 = "", string parm7 = "", string parm8 = "", string parm9 = "", string parm10 = "")
        {
            try
            {
                dbConn = new SqlConnection(conStr);
