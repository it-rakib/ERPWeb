...
namespace DBManager
{
    public class CommonConnectionAll
    {
        ...
        private static string conStringName = "";

        /// <summary>
        /// default connection string name is "SqlConnectionString"
        /// </summary>
        //public CommonConnectionAll()
        //{
        //    conStringName = "SqlConnectionString";//default database
        ...
        //}
        /// <summary>
        /// conStrName=provide sql server connection string name from web config
        /// </summary>
        /// <param name="conStrName"></param>
        public CommonConnectionAll(string conStrName = "SqlConnectionString")
        {
            conStringName = conStrName;
            constring = ConfigurationManager.ConnectionStrings[conStrName].ToString();
            con = new SqlConnection(constring);
            if (ConfigurationSettings.AppSettings != null)
            {
                var connectionType = "SQL";
        ...
        public CommonConnectionAll(IsolationLevel readCommitted)
        {
            ...
            if (ConnectionType != null && ConnectionType == "SQL")
            {
                ...
                dbConnection = new SqlConnection(connections[conStringName].ConnectionString);
                IsConfigureDb = true;
            }
            else
            {
