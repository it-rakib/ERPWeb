...
{
    public class UserWiseItemController : Controller
    {

        //public ActionResult UserSettings()
        //{
        //    if (Session["CurrentUser"] == null) return RedirectToAction("Logoff", "Home");
        //    return View(prefixed + "/UserSettings");
        //}
        private static readonly IUserRepository _userRepository = new UserService();
        public ActionResult UserWiseItemSettings()
        {
            ...
            if (Session["CurrentUser"] != null)
            {
                ...
                return View("../MERCHN/UserWiseItem/UserWiseItemSettings");
            }
            else
            {
