using BLL.FileManager;
using Entities.Core.User;
using ERP_WEB.Models.FileManager;
using System;
using System.IO;
using System.Linq;
using System.Web;
...
namespace ERP_WEB.Controllers.FileManager
{
    public class FileManagerController : Controller
    {
        private readonly IFileManagerRepository _fileManagerRepository = new FileManagerService();
        ...
        public JsonResult GetAllFilesData()
        {
            var user = (UserInfo)Session["CurrentUser"];
            var res = _fileManagerRepository.GetAllFilesData();
