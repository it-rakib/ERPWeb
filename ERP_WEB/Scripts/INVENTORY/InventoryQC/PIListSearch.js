...
var PIListSearchManager = {
    gridDataSource: function () {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: _baseUrl + '/api/InvQC/GetPIGridByInvRcv',
                    type: "POST",
                    dataType: "json",
    ...
    InitPIListSearch: function () {
        ...
        $("#grdPISummary").on("dblclick", "tr.k-state-selected", function () {
            ...
            if (selectedItem != null) {
                ...
                ConsignmentListHelper.LoadConsignmentGrid(selectedItem)
            }
        });
    },
    ...
    GeneratePISummaryGrid: function () {
        $("#grdPISummary").kendoGrid({
            ...
            columns: [
                ...
                { field: "PIDate", title: "PI Date", width: 25, sortable: true, template: '#=kendo.toString(PIDate==null?"":PIDate,"dd-MMM-yyyy")#' },
                { field: "ShipmentDate", title: "Ship Date", width: 25, sortable: true, template: '#=kendo.toString(kendo.parseDate(ShipmentDate==null?"":ShipmentDate),"dd-MMM-yyyy")#' },
                ...
                { field: "PIValue", title: "PI Value", width: 30, sortable: true },
                { field: "TotalAmount", title: "Total Amount", width: 30, sortable: true },
                {
                  field: "Action",
                    command: [{
