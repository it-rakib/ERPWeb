var SubContractReturnItemListManager = {
    GetSubContractRcvInfoByStyleAndStoreId: function (styleDetailsId, storeId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/SubContractReturn/GetSubContractRcvInfoByStyleAndStoreId/" + styleDetailsId + "/" + storeId;
    ...
    GetSubContractReturnDetailsItemByIssueId: function (issueId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/SubContractReturn/GetSubContractReturnDetailsByIssueId/" + issueId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var SubContractReturnItemListHelper = {
    InitSubContractReturnItemList: function () {
        SubContractReturnItemListHelper.GenerateItemGrid();
    },
    GenerateItemGrid: function () {
        $("#grdSubContractReturnItemList").kendoGrid({
            noRecords: true,
            messages: {
            ...
            columns: [
                ...
                { field: "SubContractRcvQty", title: "Receive Qty", editable: false },
            ...
            dataBound: function (e) {
                ...
                rows.each(function (index, row) {
                    ...
                    var tableHeadRow = $("#grdSubContractReturnItemList thead tr");
                    if (!dataItem.name) {
            ...
            edit: function (e) {
                if ((e.model.SubContractRcvQty - e.model.ReturnQty) === 0) {
                    //this.closeCell();
                }
            }
        });
    ...
    LoadReturnItemListGridByStyle: function (obj) {
        if (obj !== null) {
            ...
            var itemList = SubContractReturnItemListManager.GetSubContractRcvInfoByStyleAndStoreId(obj.StyleDetailId,storeId);
