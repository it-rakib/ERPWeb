var RequisitionItemListManager = {
    GetItemListForFloorReqByStyleDetailsAndStoreId: function (styleDetailId,storeId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/FloorRequisition/GetRcvInfoByStyleAndStoreId/" + styleDetailId + "/" + storeId;
    ...
    GetFloorReqDetailsByReqId: function (requisitionId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/FloorRequisition/GetFloorReqDetailsByReqId/" + requisitionId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var RequisitionItemListHelper = {
    ...
    GenerateItemGrid: function () {
        $("#grdRequisitionItemSummary").kendoGrid({
            ...
            columns: [
                ...
                { field: "RequiredQty", title: "Req. Qty", editor: RequisitionItemListHelper.NumericTextBoxEditor, editable: false },
    ...
    LoadRequisitionItemListGrid: function (obj) {
        if (obj !== null) {
            ...
            var itemList = RequisitionItemListManager.GetItemListForFloorReqByStyleDetailsAndStoreId(obj.StyleDetailId,storeId);
