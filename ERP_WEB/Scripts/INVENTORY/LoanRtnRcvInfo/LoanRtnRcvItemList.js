var RtnRcvItemListManager = {
    GetLoanRtnRcvDetailsByReceiveId: function (receiveId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/LoanRtnRcv/GetLoanRtnRcvDetailsByReceiveId/" + receiveId;
    ...
    GetLoanRtnDetailsItemByIssueId: function (issueId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/LoanRtnRcv/GetLoanRtnDetailsByIssueId/" + issueId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var RtnRcvItemListHelper = {
    ...
    GenerateItemGrid: function () {
        $("#grdLoanRtnRcvItemSummary").kendoGrid({
            noRecords: true,
            messages: {
            ...
            columns: [
                ...
                { field: "TotalLRcvQty", title: "Loan Rcv Qty", editable: false },
            ...
            dataBound: function (e) {
                ...
                rows.each(function (index, row) {
                    ...
                    var tableHeadRow = $("#grdLoanRtnRcvItemSummary thead tr");
                    if (!dataItem.name) {
    ...
    LoadReturnItemListGridByIssueId: function (obj) {
        if (obj !== null) {
            ...
            var grid = $("#grdLoanRtnRcvItemSummary").data("kendoGrid");
            grid.dataSource.data([]);
            var itemList = RtnRcvItemListManager.GetLoanRtnDetailsItemByIssueId(obj.IssueId);
