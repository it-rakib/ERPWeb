var IssueReceiveItemListManager = {
    GetLoanReceiveDetailsByReceiveId: function (receiveId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/LoanIssueReceive/GetLoanReceiveDetailsByReceiveId/" + receiveId;
    ...
    GetLoanIssueDetailsItemByIssueId: function (issueId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/LoanIssueReceive/GetLoanIssueDetailsItemByIssueId/" + issueId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var IssueReceiveItemListHelper = {
    ...
    GenerateItemGrid: function () {
        $("#grdLoanIssueReceiveItemSummary").kendoGrid({
            noRecords: true,
            messages: {
            ...
            dataBound: function (e) {
                ...
                rows.each(function (index, row) {
                    ...
                    var tableHeadRow = $("#grdLoanIssueReceiveItemSummary thead tr");
                    if (!dataItem.name) {
    ...
    LoadIssueItemListGridByIssueId: function (obj) {
        if (obj !== null) {
            ...
            var grid = $("#grdLoanIssueReceiveItemSummary").data("kendoGrid");
