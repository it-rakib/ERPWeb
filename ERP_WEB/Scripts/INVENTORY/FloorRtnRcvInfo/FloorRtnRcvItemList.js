var RtnRcvItemListManager = {
    GetFloorRtnRcvDetailsByReceiveId: function (receiveId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/FloorRtnRcv/GetFloorRtnRcvDetailsByReceiveId/" + receiveId;
    ...
    GetFloorRtnDetailsItemByIssueId: function (issueId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/FloorRtnRcv/GetFloorRtnDetailsByIssueId/" + issueId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var RtnRcvItemListHelper = {
    ...
    GenerateItemGrid: function () {
        $("#grdFloorRtnRcvItemSummary").kendoGrid({
            noRecords: true,
            messages: {
            ...
            columns: [
                ...
                { field: "TotalFRcvQty", title: "Floor Rcv Qty", editable: false },
            ...
            dataBound: function (e) {
                ...
                rows.each(function (index, row) {
                    ...
                    var tableHeadRow = $("#grdFloorRtnRcvItemSummary thead tr");
                    if (!dataItem.name) {
    ...
    LoadIssueItemListGridByIssueId: function (obj) {
        if (obj !== null) {
            ...
            var grid = $("#grdFloorRtnRcvItemSummary").data("kendoGrid");
            grid.dataSource.data([]);
            var itemList = RtnRcvItemListManager.GetFloorRtnDetailsItemByIssueId(obj.IssueId);
