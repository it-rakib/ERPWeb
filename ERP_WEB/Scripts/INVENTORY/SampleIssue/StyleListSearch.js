...
var StyleSearchHelper = {
    InitStyleList: function () {
        StyleSearchHelper.GenerateStyleSummaryGrid();

        $('#txtsearch').on('input', function (e) {
            StyleSearchHelper.LoadDataSource();
        });
    ...
    GenerateStyleSummaryGrid: function () {
        $("#grdStyleSummary").kendoGrid({
            ...
            columns: [
                ...
                {
                    command: [{
                        name: "edit", text: "", iconClass: "k-icon k-i-arrow-down", className: "k-success", click: StyleSearchHelper.ClickEventForSelectButton
    ...
    LoadDataSource: function () {
        ...
        var grid = $("#grdStyleSummary").data("kendoGrid");
        var data = StyleSearchManager.gridDataSource(storeId);
