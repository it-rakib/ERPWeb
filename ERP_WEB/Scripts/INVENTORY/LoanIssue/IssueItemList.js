var IssueItemListManager = {
    GetLoanRequisitionInfoByRequisitionId: function (requisitionId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/LoanIssue/GetLoanRequisitionInfoByRequisitionId/" + requisitionId;
    ...
    GetLoanIssueDetailsByIssueId: function (issueId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/LoanIssue/GetLoanIssueDetailsByIssueId/" + issueId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var IssueItemListHelper = {
    ...
    LoadIssueItemListGridByRequisition: function (obj) {
        if (obj !== null) {
            ...
            var itemList = IssueItemListManager.GetLoanRequisitionInfoByRequisitionId(obj.RequisitionId);
