var IssueReceiveItemListManager = {
    GetIssueReceiveDetailsByReceiveId: function (issueReceiveId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/StoreIssueReceive/GetIssueReceiveDetailsByReceiveId/" + issueReceiveId;
    ...
    GetIssueDetailsItemByIssueId: function (issueId) {
        var objItem = "";
        var jsonParam = "";
        var serviceUrl = _baseUrl + "/api/StoreIssueReceive/GetIssueDetailsItemByIssueId/" + issueId;
        AjaxManager.GetJsonResult(serviceUrl, jsonParam, false, false, onSuccess, onFailed);
        function onSuccess(jsonData) {
            objItem = jsonData;
        }
...
var IssueReceiveItemListHelper = {
    ...
    GenerateItemGrid: function () {
        $("#grdStoreIssueReceiveItemSummary").kendoGrid({
            noRecords: true,
            messages: {
            ...
            dataBound: function (e) {
                ...
                rows.each(function (index, row) {
                    ...
                    var tableHeadRow = $("#grdStoreIssueReceiveItemSummary thead tr");
                    if (!dataItem.name) {
    ...
    LoadIssueItemListGridByIssueId: function (obj) {
        if (obj !== null) {
            ...
            var grid = $("#grdStoreIssueReceiveItemSummary").data("kendoGrid");
