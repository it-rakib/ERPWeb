    ...
    GenerateMutationMasterGrid: function () {
        $("#grdMutationMasterSummary").kendoGrid({
            ...
            columns: [
                ...
                {
                    command: [{
                        name: "edit", text: "Edit", iconClass: "k-icon k-i-edit", className: "k-success", click: MutationInfoSummaryHelper.ClickEventForEditButtonMutationMaster
                    }
                ...
                },
                {
                    command: [
                        {
                            name: "delete", text: "Delete", iconClass: "k-icon k-i-delete", className: "k-danger", click: MutationInfoSummaryHelper.ClickEventForDeleteButtonLandMutation
                        }
                    ], hidden: !isAdmin, title: "&nbsp;"
                }
