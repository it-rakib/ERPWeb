    ...
    GenerateLandMapGrid: function () {
        $("#grdLandMapSummary").kendoGrid({
            ...
            columns: [
                ...
                {
                    command: [{
                        name: "edit", text: "Edit", iconClass: "k-icon k-i-edit", className: "k-success", click: LandMapSummaryHelper.ClickEventForEditButton
                    }
                    ],title: "&nbsp;"
                },
                {
                    command: [
                        {
                            name: "delete", text: "Delete", iconClass: "k-icon k-i-delete", className: "k-danger", click: LandMapSummaryHelper.ClickEventForDeleteButton
                        }
