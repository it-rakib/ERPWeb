    ...
    GenerateFabricEmbGrid: function () {
        $("#grdFabricEmbSummary").kendoGrid({
            ...
            columns: [
                ...
                { field: "Rate", title: "Rate", editor: FabricEmbellishmentSummaryHelper.NumericTextBoxEditor, footerTemplate: "Total : <span id='spnTotalRate'></span>" }
            ],
            editable: true,
            selectable: "row",
            navigatable: true
            ...
            schema: {
                model: {
                    fields: {
                        ...
                        Rate: { editable: true,type:'number',decimals:4,format:"n4" },
