...
var POInfoSummaryHelper = {
    ...
    GeneratePOSummaryGrid: function () {
        $("#grdPOSummaryAcknowledgement").kendoGrid({
            ...
            columns: [
                ...
                { field: "POAcckStatusName", title: "Acck Status", sortable: true, width: 30 },
                {
                    field: "", width: 30, command: [{
                        name: "edit", text: "Details", iconClass: "k-icon k-i-eye", className: "k-primary", click: POInfoSummaryHelper.ClickEventForEditButton
                    }], title: "Action &nbsp;"
                }],
            editable: false,
            selectable: "row",
    ...
    ClickEventForEditButton: function (e) {
        e.preventDefault();
        var grid = $("#grdPOSummaryAcknowledgement").data("kendoGrid");
