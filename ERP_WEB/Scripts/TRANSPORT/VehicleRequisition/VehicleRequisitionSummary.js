var isAdmin = false;
var VehicleRequisitionSummaryManager = {
    gridDataSource: function () {
        var gridDataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: _baseUrlTransport + '/api/VehicleRequisition/GetAllGridData',
                    type: "POST",
                    dataType: "json",
...
var VehicleRequisitionSummaryHelper = {
    InitVehicleRequisitionSummary: function () {
        ...
        VehicleRequisitionSummaryHelper.GenerateVehicleRequisitionGrid();
        VehicleRequisitionSummaryHelper.GeneratePassengerGrid();
    },

    GenerateVehicleRequisitionGrid: function () {
        $("#grdVehicleRequisition").kendoGrid({
            dataSource: VehicleRequisitionSummaryManager.gridDataSource(),
            pageable: {
                refresh: true,
                serverPaging: true,
                serverFiltering: true,
            ...
            columns: [
                ...
                {
                    command: [{
                        name: "edit", text: "Edit", iconClass: "k-icon k-i-edit", className: "k-success", click: VehicleRequisitionSummaryHelper.ClickEventForVehicleReqEditButton
                    }], /*hidden: !isAdmin,*/ title: "&nbsp;"
                },
                {
                    command: [
                        {
                            name: "delete", text: "Delete", iconClass: "k-icon k-i-delete", className: "k-danger", click: VehicleRequisitionSummaryHelper.ClickEventForDeleteButton
                        }
                    ], hidden: !isAdmin, title: "&nbsp;"
                }
    ...
    ClickEventForVehicleReqEditButton: function (e) {
        ...
        if (selectedItem1 != null) {
            ...
            VehicleRequisitionDetailsHelper.FillVehicleRequisitionForm(selectedItem1);
        }
    },
    ClickEventForDeleteButton: function (e) {
        ...
        if (confirm("Are you sure you want to delete?") == true) {
            ...
            if (selectedItem != null) {
                ...
                VehicleRequisitionDetailsHelper.FillVehicleRequisitionForm(selectedItem);
            ...
            columns: [
                ...
                { field: "Stoppage", title: "Stoppage"},
                {
                    field: "Action", title: "Action", filterable: false, command: [
                        {
                        name: "delete", text: "Delete", iconClass: "k-icon k-i-delete", className: "k-danger", click: VehicleRequisitionSummaryHelper.ClickEventForDeleteButtonPassenger
                    },
                    {
                        name: "edit", text: "Edit", iconClass: "k-icon k-i-edit", className: "k-success", click: VehicleRequisitionSummaryHelper.ClickEventForEditButtonPassenger
                    }]
                }
            ],
            editable: false,
    ...
    ClickEventForEditButtonPassenger: function (e) {
        ...
        grid.select(tr);
        if (selectedItem != null) {
            VehicleRequisitionDetailsHelper.FillPassengerForm(selectedItem);
        }
    },
